package uk.gov.hmrc.agentauthorisationtestsupportapi
...
class ExampleIntegrationTest extends WordSpec with Matchers with ServiceSpec  {
  ...
  "This integration test" should {
    "start services via smserver" in {
      ...
      val response = wsClient.url(resource("/agent-authorisation-test-support-api/hello-world")).get.futureValue
